...
curl -X POST \
   ...
   "https://<ENDPOINT_LOCATION>-global-discoveryengine.googleapis.com/v1alpha/projects/<YOUR_PROJECT_ID>/locations/<LOCATION>/authorizations?authorizationId=<AUTH_ID>" \
   -d '{
